...
launch_sites_disp = []
launch_sites_disp.append({'label': 'All Sites', 'value': 'All Sites'})
for launch_site in unique_launch_sites:
    launch_sites_disp.append({'label': launch_site, 'value': launch_site})
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All Sites' or entered_site == 'None':
        data  = filtered_df[spacex_df['class'] == 1]
        fig = px.pie(
                data,
                names = 'Launch Site',
